/datum/job/medical_doctor
	...
	flag = DOCTOR
	description = "Assist in treating patients with a wide range of medical issues under supervision. Learn to administer treatments for minor wounds, assist in surgeries, and provide support in critical situations. Gain experience in using various medical tools and techniques, including medications, surgical procedures, and diagnostic methods. Collaborate with Medical Doctors to provide comprehensive patient care and support."
